...
const CARDS = [
  {
    ...
    title: 'Students',
    titleColor: '#62a135',
    body: "Close gaps instantly with AI guidance, right when they're stuck",
  ...
  },
  {
    ...
    title: 'Teachers',
    titleColor: '#c44a4a',
    body: "Save time on correction and teach with clear insight into every student",
  ...
  },
  {
    ...
    title: 'Parents',
    titleColor: '#6554c7',
    body: 'Gain clear guidance and reduce dependence on extra tuition',
  ...
  },
  {
    ...
    title: 'School',
    titleColor: '#2e2f2d',
    body: 'Better outcomes, efficient teaching, and parent trust drive reputation and growth',
