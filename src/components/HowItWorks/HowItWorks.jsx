...
/* ── Assets ──────────────────────────────────────────────── */
const SCHOOL_AI_LOGO_LEFT  = 'http://localhost:3845/assets/128bcf7d26282a72f274e095622049314669b70c.svg';
const SCHOOL_AI_LOGO_RIGHT = 'http://localhost:3845/assets/b79886e508077f22b2f4fa5f999983e0684f0ed7.svg';
const BY_COSCHOOL          = 'http://localhost:3845/assets/dceefcdd05c9fb15ba2e9eb40b80b6f74efb34c0.svg';
const VERT_LINE            = 'http://localhost:3845/assets/20d546716f32dd9555996edc108f0db820f3f1fe.svg';
const CHECK_ICON           = 'http://localhost:3845/assets/98dee7337dbe634d9da372ca8650a1cb1a5ec704.svg';
const ACCENT_MARK          = 'http://localhost:3845/assets/e1817a74f1a3ad3fe2eb77fa22a85cf11227d305.svg';
const IPAD_FRAME           = 'http://localhost:3845/assets/113f6c88d43c35ec11a950e6656f2781a318356c.png';
...
const PERSONA_DATA = [
  {
    ...
    screenSrc: 'http://localhost:3845/assets/de0511d6ca4655271fdce0eb2eb0753e8b72f669.png',
  ...
  },
  {
    ...
    screenSrc: 'http://localhost:3845/assets/cb1235a3896fed456878160b7b5b29c154f2f94b.png',
    imageLeft: true,
  },
  {
    id: 'parent',
    ...
    screenSrc: 'http://localhost:3845/assets/1c63e34f92b80349e2364f3e551c5057aa1cee4f.png',
    imageLeft: false,
  },
  {
    id: 'admin',
    ...
    screenSrc: 'http://localhost:3845/assets/71cc0798fdcb1e14b3d0fbf37d1137e8a3480bf8.png',
    imageLeft: true,
  },
];
